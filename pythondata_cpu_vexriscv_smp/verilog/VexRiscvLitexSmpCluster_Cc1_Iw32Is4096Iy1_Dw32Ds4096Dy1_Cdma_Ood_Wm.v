...
// Component : VexRiscvLitexSmpCluster_Cc1_Iw32Is4096Iy1_Dw32Ds4096Dy1_Cdma_Ood_Wm
...
module VexRiscvLitexSmpCluster_Cc1_Iw32Is4096Iy1_Dw32Ds4096Dy1_Cdma_Ood_Wm (
...
module DataCache (
  ...
  assign _zz_21 = ((io_mem_cmd_valid && io_mem_cmd_ready) && io_mem_cmd_payload_wr);
  assign _zz_22 = (io_cpu_execute_isValid && (! io_cpu_memory_isStuck));
  assign _zz_23 = (! stageB_flusher_counter[6]);
  ...
  assign _zz_25 = (invalidate_s2_input_valid && invalidate_s2_input_payload_fragment_enable);
  assign _zz_26 = ((loader_valid && io_mem_rsp_valid) && rspLast);
  assign _zz_27 = (stageB_mmuRsp_isIoAccess || stageB_request_isLrsc);
  assign _zz_28 = (stageB_waysHit || (stageB_request_wr && (! stageB_isAmoCached)));
  assign _zz_29 = (((! stageB_request_wr) || stageB_isAmoCached) && ((stageB_dataColisions & stageB_waysHits) != 1'b0));
  assign _zz_30 = (io_mem_rsp_valid && pending_last);
  assign _zz_31 = (stageB_request_amoCtrl_alu | {stageB_request_amoCtrl_swap,2'b00});
  assign _zz_32 = _zz_5[0 : 0];
  assign _zz_33 = _zz_5[1 : 1];
  assign _zz_34 = _zz_6[0 : 0];
  assign _zz_35 = _zz_6[1 : 1];
  assign _zz_36 = (pending_counter + _zz_38);
  assign _zz_37 = ((io_mem_cmd_valid && io_mem_cmd_ready) && io_mem_cmd_payload_last);
  assign _zz_38 = {6'd0, _zz_37};
  assign _zz_39 = ((io_mem_rsp_valid && io_mem_rsp_payload_last) ? _zz_41 : 2'b00);
  assign _zz_40 = {5'd0, _zz_39};
  assign _zz_41 = (_zz_43 + {1'b0,1'b1});
  assign _zz_42 = 1'b0;
  assign _zz_43 = {1'd0, _zz_42};
  assign _zz_44 = 1'b0;
  assign _zz_45 = {1'd0, _zz_44};
  assign _zz_46 = sync_syncContext_wPtr[5:0];
  assign _zz_47 = {5'd0, sync_syncCount};
  assign _zz_48 = _zz_7[5:0];
  assign _zz_49 = (sync_syncContext_wPtr - sync_syncContext_rPtr);
  assign _zz_50 = (sync_writeCached_pendingSync + _zz_52);
  assign _zz_51 = (((io_mem_cmd_valid && io_mem_cmd_ready) && io_mem_cmd_payload_wr) && (! io_mem_cmd_payload_uncached));
  assign _zz_52 = {6'd0, _zz_51};
  assign _zz_53 = (((io_mem_sync_valid && io_mem_sync_ready) && (! sync_syncContext_uncached)) ? sync_syncCount : 2'b00);
  assign _zz_54 = {5'd0, _zz_53};
  assign _zz_55 = (sync_writeUncached_pendingSync + _zz_57);
  assign _zz_56 = (((io_mem_cmd_valid && io_mem_cmd_ready) && io_mem_cmd_payload_wr) && io_mem_cmd_payload_uncached);
  assign _zz_57 = {6'd0, _zz_56};
  assign _zz_58 = (((io_mem_sync_valid && io_mem_sync_ready) && sync_syncContext_uncached) ? sync_syncCount : 2'b00);
  assign _zz_59 = {5'd0, _zz_58};
  assign _zz_60 = ((((io_mem_sync_valid && io_mem_sync_ready) && (sync_w2w_counter != 7'h0)) && (! sync_syncContext_uncached)) ? sync_syncCount : 2'b00);
  assign _zz_61 = {5'd0, _zz_60};
  assign _zz_62 = ((((io_mem_sync_valid && io_mem_sync_ready) && (sync_w2r_counter != 7'h0)) && (! sync_syncContext_uncached)) ? sync_syncCount : 2'b00);
  assign _zz_63 = {5'd0, _zz_62};
  assign _zz_64 = ((((io_mem_sync_valid && io_mem_sync_ready) && (sync_w2i_counter != 7'h0)) && (! sync_syncContext_uncached)) ? sync_syncCount : 2'b00);
  assign _zz_65 = {5'd0, _zz_64};
  assign _zz_66 = ((((io_mem_sync_valid && io_mem_sync_ready) && (sync_w2o_counter != 7'h0)) && (! sync_syncContext_uncached)) ? sync_syncCount : 2'b00);
  assign _zz_67 = {5'd0, _zz_66};
  assign _zz_68 = ((((io_mem_sync_valid && io_mem_sync_ready) && (sync_o2w_counter != 7'h0)) && sync_syncContext_uncached) ? sync_syncCount : 2'b00);
  assign _zz_69 = {5'd0, _zz_68};
  assign _zz_70 = ((((io_mem_sync_valid && io_mem_sync_ready) && (sync_o2r_counter != 7'h0)) && sync_syncContext_uncached) ? sync_syncCount : 2'b00);
  assign _zz_71 = {5'd0, _zz_70};
  assign _zz_72 = (io_cpu_execute_address[11 : 2] >>> 0);
  assign _zz_73 = (io_cpu_memory_address[11 : 2] >>> 0);
  assign _zz_74 = ($signed(_zz_75) + $signed(_zz_79));
  assign _zz_75 = ($signed(_zz_76) + $signed(_zz_77));
  assign _zz_76 = io_cpu_writeBack_storeData[31 : 0];
  assign _zz_77 = (stageB_amo_compare ? (~ stageB_ioMemRspMuxed[31 : 0]) : stageB_ioMemRspMuxed[31 : 0]);
  assign _zz_78 = (stageB_amo_compare ? _zz_80 : _zz_81);
  assign _zz_79 = {{30{_zz_78[1]}}, _zz_78};
  assign _zz_80 = 2'b01;
  assign _zz_81 = 2'b00;
  assign _zz_82 = io_cpu_writeBack_storeData[31 : 0];
  assign _zz_83 = stageB_ioMemRspMuxed[31 : 0];
  assign _zz_84 = stageB_ioMemRspMuxed[31 : 0];
  assign _zz_85 = io_cpu_writeBack_storeData[31 : 0];
  assign _zz_86 = 1'b1;
  assign _zz_87 = loader_counter_willIncrement;
  assign _zz_88 = {3'd0, _zz_87};
  assign _zz_89 = {loader_waysAllocator,loader_waysAllocator[0]};
  assign _zz_90 = {tagsWriteCmd_payload_data_address,{tagsWriteCmd_payload_data_error,tagsWriteCmd_payload_data_valid}};
  assign _zz_91 = io_mem_cmd_payload_uncached;
  always @ (posedge debugCd_external_clk) begin
    if(_zz_4) begin
      _zz_18 <= ways_0_tags[tagsReadCmd_payload];
    end
  end

  always @ (posedge debugCd_external_clk) begin
    if(tagsInvReadCmd_valid) begin
      _zz_19 <= ways_0_tags[tagsInvReadCmd_payload];
    end
  end

  always @ (posedge debugCd_external_clk) begin
    if(_zz_3) begin
      ways_0_tags[tagsWriteCmd_payload_address] <= _zz_90;
    end
  end

  always @ (posedge debugCd_external_clk) begin
    if(_zz_1) begin
      sync_syncContext_history[_zz_46] <= _zz_91;
    end
  end

  assign _zz_20 = sync_syncContext_history[_zz_48];
  Ram_1w_1rs #(
    .wordCount(1024),
    .wordWidth(32),
    .clockCrossing(1'b0),
  ...
  assign haltCpu = 1'b0;
  assign _zz_4 = (tagsReadCmd_valid && (! io_cpu_memory_isStuck));
  assign _zz_5 = _zz_18;
  assign ways_0_tagsReadRsp_valid = _zz_32[0];
  assign ways_0_tagsReadRsp_error = _zz_33[0];
  assign ways_0_tagsReadRsp_address = _zz_5[21 : 2];
  assign ways_0_dataReadRspMem = ways_0_data_rd_data;
  assign ways_0_dataReadRsp = ways_0_dataReadRspMem[31 : 0];
  assign _zz_6 = _zz_19;
  assign ways_0_tagsInvReadRsp_valid = _zz_34[0];
  assign ways_0_tagsInvReadRsp_error = _zz_35[0];
  assign ways_0_tagsInvReadRsp_address = _zz_6[21 : 2];
  always @ (*) begin
  ...
  assign pending_counterNext = (_zz_36 - _zz_40);
  assign io_mem_sync_ready = 1'b1;
  assign sync_syncCount = (_zz_45 + {1'b0,1'b1});
  assign _zz_7 = sync_syncContext_rPtr;
  assign sync_syncContext_uncached = _zz_20[0];
  assign sync_writeCached_pendingSyncNext = (_zz_50 - _zz_54);
  assign sync_writeUncached_pendingSyncNext = (_zz_55 - _zz_59);
  ...
  assign stage0_mask = (_zz_8 <<< io_cpu_execute_address[1 : 0]);
  assign stage0_dataColisions[0] = (((dataWriteCmd_valid && dataWriteCmd_payload_way[0]) && (dataWriteCmd_payload_address == _zz_72)) && ((stage0_mask & dataWriteCmd_payload_mask[3 : 0]) != 4'b0000));
  always @ (*) begin
  ...
  assign stageA_consistancyCheck_r = ((_zz_9 || sync_w2r_busy) || sync_o2r_busy);
  ...
  assign _zz_10[0] = ((io_cpu_memory_mmuRsp_physicalAddress[31 : 12] == ways_0_tagsReadRsp_address) && ways_0_tagsReadRsp_valid);
  assign stageA_wayHits = _zz_10;
  assign _zz_11[0] = (((dataWriteCmd_valid && dataWriteCmd_payload_way[0]) && (dataWriteCmd_payload_address == _zz_73)) && ((stageA_mask & dataWriteCmd_payload_mask[3 : 0]) != 4'b0000));
  ...
  always @ (*) begin
    ...
    if(io_cpu_writeBack_isValid)begin
      if(stageB_request_isAmo)begin
        ...
        if(_zz_27)begin
          if((_zz_12 ? (io_mem_rsp_valid && rspSync) : io_mem_cmd_ready))begin
            io_cpu_writeBack_haltIt = 1'b0;
          end
        end else begin
          if(_zz_28)begin
  ...
  assign stageB_amo_addSub = _zz_74;
  assign stageB_amo_less = ((_zz_82[31] == _zz_83[31]) ? stageB_amo_addSub[31] : (stageB_amo_unsigned ? _zz_84[31] : _zz_85[31]));
  ...
  always @ (*) begin
    ...
    if(stageB_bypassCache)begin
      ...
      io_cpu_writeBack_accessError = (((stageB_waysHits & _zz_13) != 1'b0) || (stageB_loadStoreFault && (! stageB_mmuRsp_isPaging)));
    end
  end
  ...
  assign _zz_13[0] = stageB_tagsReadRsp_0_error;
  ...
  always @ (*) begin
    loader_counter_valueNext = (loader_counter_value + _zz_88);
  ...
  assign _zz_14[0] = ((invalidate_s1_input_payload_fragment_address[31 : 12] == ways_0_tagsInvReadRsp_address) && ways_0_tagsInvReadRsp_valid);
  assign invalidate_s1_wayHits = (_zz_14 & (~ invalidate_s1_invalidations));
  ...
  assign invalidate_s1_invalidations = _zz_15;
  assign _zz_16 = (_zz_2 && 1'b1);
  assign _zz_17 = ((dataReadCmd_valid && (! io_cpu_memory_isStuck)) && 1'b1);
  always @ (posedge debugCd_external_clk) begin
    ...
    sync_syncContext_full <= (7'h3f <= _zz_49);
    ...
    if((! io_cpu_memory_isStuck))begin
      _zz_9 <= (sync_w2r_busy || sync_o2r_busy);
    end
    if((! io_cpu_memory_isStuck))begin
    ...
    if(io_mem_inv_ready)begin
      _zz_15 <= (((invalidate_s2_input_valid && invalidate_s2_input_payload_fragment_enable) && (invalidate_s2_input_payload_fragment_address[11 : 6] == io_mem_inv_payload_fragment_address[11 : 6])) ? invalidate_s2_wayHits : 1'b0);
    end
  end
  ...
  always @ (posedge debugCd_external_clk) begin
    if(systemCd_logic_outputReset) begin
      ...
      if((io_mem_sync_valid && io_mem_sync_ready))begin
        sync_syncContext_rPtr <= (sync_syncContext_rPtr + _zz_47);
      end
      ...
      if((! loader_valid))begin
        loader_waysAllocator <= _zz_89[0:0];
      end
      if(io_mem_inv_ready)begin
