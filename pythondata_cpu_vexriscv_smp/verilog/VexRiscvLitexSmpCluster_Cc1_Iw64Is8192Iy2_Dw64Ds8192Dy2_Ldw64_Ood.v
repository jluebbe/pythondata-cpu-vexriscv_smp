...
// Component : VexRiscvLitexSmpCluster_Cc1_Iw64Is8192Iy2_Dw64Ds8192Dy2_Ldw64_Ood
...
module VexRiscvLitexSmpCluster_Cc1_Iw64Is8192Iy2_Dw64Ds8192Dy2_Ldw64_Ood (
  ...
  reg        [4:0]    dBridge_bmb_slaveModel_arbiterGen_oneToOne_arbiter_cmd_s2mPipe_rData_fragment_context;
  wire                _zz_445;
  ...
  reg        [5:0]    peripheralBridge_bmb_arbiter_io_output_cmd_halfPipe_regs_payload_fragment_context;
  wire                _zz_446;
  reg                 _zz_447;
  reg                 _zz_448;
  reg        [0:0]    _zz_449;
  ...
  assign _zz_463 = (debugCd_logic_holdingLogic_resetCounter != 12'hfff);
  assign _zz_464 = (systemCd_logic_holdingLogic_resetCounter != 6'h3f);
  assign _zz_465 = (plic_logic_bridge_coherencyStall_value != 1'b0);
  assign _zz_466 = (cores_0_cpu_logic_cpu_dBus_cmd_valid && _zz_126);
  assign _zz_467 = ((dBus_Bridge_withWriteBuffer_aggregationSel == 1'b0) && cores_0_cpu_logic_cpu_dBus_cmd_payload_mask[0]);
  assign _zz_468 = ((dBus_Bridge_withWriteBuffer_aggregationSel == 1'b0) && cores_0_cpu_logic_cpu_dBus_cmd_payload_mask[1]);
  assign _zz_469 = ((dBus_Bridge_withWriteBuffer_aggregationSel == 1'b0) && cores_0_cpu_logic_cpu_dBus_cmd_payload_mask[2]);
  assign _zz_470 = ((dBus_Bridge_withWriteBuffer_aggregationSel == 1'b0) && cores_0_cpu_logic_cpu_dBus_cmd_payload_mask[3]);
  assign _zz_471 = ((dBus_Bridge_withWriteBuffer_aggregationSel == 1'b1) && cores_0_cpu_logic_cpu_dBus_cmd_payload_mask[0]);
  assign _zz_472 = ((dBus_Bridge_withWriteBuffer_aggregationSel == 1'b1) && cores_0_cpu_logic_cpu_dBus_cmd_payload_mask[1]);
  assign _zz_473 = ((dBus_Bridge_withWriteBuffer_aggregationSel == 1'b1) && cores_0_cpu_logic_cpu_dBus_cmd_payload_mask[2]);
  assign _zz_474 = ((dBus_Bridge_withWriteBuffer_aggregationSel == 1'b1) && cores_0_cpu_logic_cpu_dBus_cmd_payload_mask[3]);
  assign _zz_475 = (dBus_Bridge_bus_cmd_ready && (! dBus_Bridge_bus_cmd_s2mPipe_ready));
  assign _zz_476 = (! cores_0_cpu_iBus_cmd_halfPipe_regs_valid);
  assign _zz_477 = (dBusCoherent_bmb_cmd_ready && (! dBusCoherent_bmb_cmd_s2mPipe_ready));
  assign _zz_478 = (! iBridge_bmb_slaveModel_arbiterGen_oneToOne_arbiter_cmd_halfPipe_regs_valid);
  assign _zz_479 = (dBusNonCoherent_bmb_cmd_ready && (! dBusNonCoherent_bmb_cmd_s2mPipe_ready));
  assign _zz_480 = (! iArbiter_bmb_cmd_halfPipe_regs_valid);
  assign _zz_481 = (dBridge_bmb_slaveModel_arbiterGen_oneToOne_arbiter_cmd_ready && (! dBridge_bmb_slaveModel_arbiterGen_oneToOne_arbiter_cmd_s2mPipe_ready));
  assign _zz_482 = (! peripheralBridge_bmb_arbiter_io_output_cmd_halfPipe_regs_valid);
  assign _zz_483 = (debugBridge_logic_debugger_io_mem_cmd_payload_address >>> 2);
  assign _zz_484 = ({3'd0,_zz_32} <<< debugBridge_logic_debugger_io_mem_cmd_payload_address[1 : 0]);
  assign _zz_485 = _zz_133[0 : 0];
  ...
  BmbArbiter peripheralBridge_bmb_arbiter (
    ...
    .io_inputs_1_cmd_payload_fragment_data       (_zz_461[31:0]                                                               ), //i
    .io_inputs_1_cmd_payload_fragment_mask       (_zz_462[3:0]                                                                ), //i
    ...
    .io_output_rsp_payload_fragment_data         (_zz_451[31:0]                                                               ), //i
    .io_output_rsp_payload_fragment_context      (_zz_452[5:0]                                                                ), //i
    .debugCd_external_clk                        (debugCd_external_clk                                                        ), //i
    .systemCd_logic_outputReset                  (systemCd_logic_outputReset                                                  )  //i
  );
  ...
  assign debugBridge_logic_mmMaster_cmd_payload_fragment_address = {_zz_483,2'b00};
  ...
  assign debugBridge_logic_mmMaster_cmd_payload_fragment_mask = _zz_484[3:0];
  ...
  assign _zz_432 = ((1'b1 && (! _zz_433)) || dBusNonCoherent_bmb_rsp_ready);
  assign _zz_433 = _zz_434;
  assign dBusNonCoherent_bmb_rsp_valid = _zz_433;
  assign dBusNonCoherent_bmb_rsp_payload_last = _zz_435;
  assign dBusNonCoherent_bmb_rsp_payload_fragment_opcode = _zz_436;
  assign dBusNonCoherent_bmb_rsp_payload_fragment_data = _zz_437;
  assign dBusNonCoherent_bmb_rsp_payload_fragment_context = _zz_438;
  ...
  assign _zz_461 = 32'bxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx;
  assign _zz_462 = 4'bxxxx;
  ...
  always @ (posedge debugCd_external_clk) begin
    if(systemCd_logic_outputReset) begin
      ...
      if(_zz_432)begin
        _zz_434 <= dBusNonCoherent_bmb_decoder_io_input_rsp_valid;
      end
      if(_zz_480)begin
  ...
  always @ (posedge debugCd_external_clk) begin
    ...
    cores_0_cpu_externalSupervisorInterrupt_plic_target_bestRequest_id <= (_zz_322 ? (_zz_316 ? (_zz_304 ? (_zz_280 ? _zz_564 : _zz_565) : (_zz_283 ? _zz_566 : _zz_567)) : (_zz_307 ? (_zz_286 ? _zz_568 : _zz_569) : (_zz_289 ? _zz_570 : _zz_571))) : (_zz_319 ? (_zz_310 ? (_zz_292 ? _zz_572 : _zz_573) : (_zz_295 ? _zz_574 : _zz_575)) : (_zz_313 ? (_zz_298 ? _zz_576 : _zz_577) : (_zz_301 ? _zz_578 : _zz_579))));
    ...
    if(_zz_432)begin
      _zz_435 <= dBusNonCoherent_bmb_decoder_io_input_rsp_payload_last;
      _zz_436 <= dBusNonCoherent_bmb_decoder_io_input_rsp_payload_fragment_opcode;
      _zz_437 <= dBusNonCoherent_bmb_decoder_io_input_rsp_payload_fragment_data;
      _zz_438 <= dBusNonCoherent_bmb_decoder_io_input_rsp_payload_fragment_context;
    end
    if(_zz_480)begin
...
module BmbDownSizerBridge (
  ...
  assign rspArea_context_context = _zz_1[5 : 1];
  assign io_input_rsp_payload_last = io_output_rsp_payload_last;
  assign io_input_rsp_payload_fragment_opcode = io_output_rsp_payload_fragment_opcode;
...
module BmbArbiter (
  ...
  StreamArbiter memory_arbiter (
    ...
    .io_inputs_1_payload_fragment_context    (_zz_3[5:0]                                               ), //i
  ...
  assign _zz_2 = 1'b0;
  assign _zz_3 = {5'd0, io_inputs_1_cmd_payload_fragment_context};
...
module BmbToWishbone (
  ...
  reg        [5:0]    io_input_cmd_payload_fragment_context_regNext;
...
module BmbToLiteDram_1 (
  ...
  wire       [2:0]    streamFork_2_io_outputs_0_payload_fragment_length;
  wire       [63:0]   streamFork_2_io_outputs_0_payload_fragment_data;
  wire       [7:0]    streamFork_2_io_outputs_0_payload_fragment_mask;
  ...
  wire       [2:0]    streamFork_2_io_outputs_1_payload_fragment_length;
  wire       [63:0]   streamFork_2_io_outputs_1_payload_fragment_data;
  wire       [7:0]    streamFork_2_io_outputs_1_payload_fragment_mask;
  ...
  wire       [2:0]    streamFork_2_io_outputs_1_thrown_payload_fragment_length;
  wire       [63:0]   streamFork_2_io_outputs_1_thrown_payload_fragment_data;
  wire       [7:0]    streamFork_2_io_outputs_1_thrown_payload_fragment_mask;
  ...
  assign _zz_16 = (streamFork_2_io_outputs_0_payload_fragment_address >>> 3);
  ...
  StreamFork_1 streamFork_2 (
    ...
    .io_input_payload_fragment_length         (io_input_unburstify_io_output_cmd_payload_fragment_length[2:0]    ), //i
    .io_input_payload_fragment_data           (io_input_unburstify_io_output_cmd_payload_fragment_data[63:0]     ), //i
    .io_input_payload_fragment_mask           (io_input_unburstify_io_output_cmd_payload_fragment_mask[7:0]      ), //i
    .io_input_payload_fragment_context        (io_input_unburstify_io_output_cmd_payload_fragment_context[6:0]   ), //i
    ...
    .io_outputs_0_payload_fragment_length     (streamFork_2_io_outputs_0_payload_fragment_length[2:0]            ), //o
    .io_outputs_0_payload_fragment_data       (streamFork_2_io_outputs_0_payload_fragment_data[63:0]             ), //o
    .io_outputs_0_payload_fragment_mask       (streamFork_2_io_outputs_0_payload_fragment_mask[7:0]              ), //o
    ...
    .io_outputs_1_payload_fragment_length     (streamFork_2_io_outputs_1_payload_fragment_length[2:0]            ), //o
    .io_outputs_1_payload_fragment_data       (streamFork_2_io_outputs_1_payload_fragment_data[63:0]             ), //o
    .io_outputs_1_payload_fragment_mask       (streamFork_2_io_outputs_1_payload_fragment_mask[7:0]              ), //o
  ...
  StreamFifoLowLatency_1 streamFifoLowLatency_3 (
    ...
    .io_push_payload_data          (streamFork_2_io_outputs_1_payload_fragment_data[63:0]  ), //i
    .io_push_payload_we            (streamFork_2_io_outputs_1_payload_fragment_mask[7:0]   ), //i
  ...
  assign outputCmd_payload_addr = {5'd0, _zz_16};
...
module BmbToLiteDram (
  ...
  assign _zz_14 = (streamFork_2_io_outputs_0_payload_fragment_address >>> 3);
  ...
  assign _zz_8 = (outputCmd_ready && _zz_2);
  assign outputCmd_valid = (streamFork_2_io_outputs_0_valid && _zz_2);
  assign outputCmd_payload_addr = {5'd0, _zz_14};
  assign outputCmd_payload_we = (streamFork_2_io_outputs_0_payload_fragment_opcode == 1'b1);
  assign outputCmd_ready = ((1'b1 && (! outputCmd_m2sPipe_valid)) || outputCmd_m2sPipe_ready);
  assign outputCmd_m2sPipe_valid = outputCmd_m2sPipe_rValid;
  assign outputCmd_m2sPipe_payload_we = outputCmd_m2sPipe_rData_we;
...
module StreamFifoLowLatency_1 (
  ...
  assign _zz_2 = _zz_3;
  assign io_pop_payload_data = _zz_2[63 : 0];
  assign io_pop_payload_we = _zz_2[71 : 64];
